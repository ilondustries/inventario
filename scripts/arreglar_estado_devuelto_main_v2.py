...
para permitir el estado 'devuelto' en tickets_compra (versión corregida)
"""
...
def arreglar_estado_devuelto_main():
    ...
    try:
        ...
        print("🧹 Limpiando tabla temporal anterior si existe...")
        cursor.execute("DROP TABLE IF EXISTS tickets_compra_temp")
        ...
        # Crear tabla temporal con la nueva restricción (incluyendo todas las columnas)
